...
```yaml
# TypeScript/React skills activation
skills_context:
  react_core: # REQUIRED
    required:
      - react-best-practices      # Hooks, effects, refs, component patterns
    recommended:
      - nextjs-supabase-auth      # If using Supabase auth
      - react-components          # Design-to-code workflows

  ui_design: # For visual components
    recommended:
      - ui-design-system          # shadcn/ui + Radix + TailwindCSS
      - ui-ux-pro-max             # Design intelligence
      - frontend-design           # Production-grade interfaces
      - tailwind-design-system    # Design tokens, responsive

  typography: # For content-heavy UIs
    recommended:
      - typography                # Type scales, hierarchy
      - web-typography            # Responsive type, font loading

  icons:
    recommended:
      - icon-design               # Lucide, Heroicons, Phosphor
      - better-icons              # CLI icon search

  backend: # For full-stack TypeScript
    recommended:
      - nodejs-backend-patterns   # Express/Fastify API patterns
...
// Example: Next.js 16 App Router - Route handlers must export named functions
...
# --- React & TypeScript (skills: react-best-practices, ui-design-system) ---
...
# --- Design Quality (skills: ui-ux-pro-max, frontend-design) ---
# Check: No generic SaaS aesthetic (purple gradients, over-rounded corners)
# Check: Hero-first design approach, consistent style inheritance
# Check: Monochrome + accent palette, big typography, clear hierarchy

# --- Typography (skills: typography, font-pairing-suggester) ---
# Verify font pairings, size scale, weight hierarchy
# Check: responsive font scaling, line-height, letter-spacing

# --- Icons (skills: icon-design, better-icons) ---
# Verify consistent icon library (e.g., iconify solar duotone)
# Check: semantic icon usage, consistent sizing

# --- Web Standards (skills: web-design-guidelines, audit-website) ---
