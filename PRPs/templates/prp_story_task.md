...
```yaml
# Story PRP - select based on story type
skills_context:
  frontend_story:
    - react-best-practices      # React component patterns
    - ui-design-system          # shadcn/ui, Radix, TailwindCSS
    - frontend-design           # Production-grade UI
    - icon-design               # Icon selection
  backend_story:
    - python-pro                # Python backend
    - nodejs-backend-patterns   # Node.js backend
    - better-auth-best-practices # Auth stories
  mobile_story:
    - flutter-expert            # Flutter development
    - flutter-testing           # Flutter tests
    - mobile-touch              # Mobile UX
  design_story:
    - ui-ux-pro-max             # Design intelligence
    - typography-expert         # Font pairing, hierarchy
    - web-design-guidelines     # Compliance
  reference: "skills-ecosystem/prp-skill-maps/SKILL-PRP-MAPPING.md"
```
...
```bash
# ═══════════════════════════════════════════════════════════
# SKILL-POWERED VALIDATION (activate per story type)
# Reference: skills-ecosystem/prp-skill-maps/SKILL-PRP-MAPPING.md
# ═══════════════════════════════════════════════════════════

# Frontend Stories (skills: web-design-guidelines, audit-website, seo-audit)
# Check: design quality, accessibility WCAG 2.1 AA, SEO metadata
# Check: typography hierarchy, icon consistency, responsive behavior

# Backend Stories (skills: python-pro, nodejs-backend-patterns)
# Check: API contracts, error handling, auth flows

# Mobile Stories (skills: flutter-expert, flutter-testing, mobile-touch)
# Check: touch targets 48dp+, platform UX, animation 60fps

# Design Stories (skills: ui-ux-pro-max, frontend-design, typography)
# Check: no generic SaaS aesthetic, hero-first approach, font pairings
