...
```yaml
# Task PRP - activate relevant skills for context
skills_context:
  backend:
    - python-pro                # Python tasks
    - nodejs-backend-patterns   # Node.js tasks
  frontend:
    - react-best-practices      # React component tasks
    - ui-design-system          # UI component tasks
    - tailwind-design-system    # Styling tasks
  testing:
    - flutter-testing           # Flutter test tasks
