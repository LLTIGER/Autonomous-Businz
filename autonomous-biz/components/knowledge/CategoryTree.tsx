        ...
        >
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between text-xs text-gray-500 mb-1">
              <span>{t.categoriesPage.autonomyScore}</span>
          ...
          <div className="mb-4 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs text-gray-500">{t.categoriesPage.revenueModel}</span>
              <span className="text-xs font-medium text-gray-700">{category.revenueModel}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-xs text-gray-500">{t.categoriesPage.typicalMonthly}</span>
              <span className="text-xs font-medium text-gray-900">{category.typicalMonthly}</span>
            </div>
          </div>

          <div className="mb-3">
            <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">{t.categoriesPage.examples}</h4>
          ...
          <div>
            <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">{t.categoriesPage.keyMetrics}</h4>
            <div className="flex flex-wrap gap-1.5">
