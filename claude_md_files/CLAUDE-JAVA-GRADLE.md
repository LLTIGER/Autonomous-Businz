...
- Configure virtual threads for better performance (Java 25)
...
### Spring Boot 4.0 Performance Features

- **Virtual Threads (Java 25)**: Enable with `spring.threads.virtual.enabled=true`
