...
This file provides comprehensive guidance to Claude Code when working with Next.js 16 applications with React 19 and TypeScript.
...
## 🚀 Next.js 16 & React 19 Key Features
...
### Essential Next.js 16 Dependencies
```json
{
  "dependencies": {
    "next": "^16.0.0",
...
*This guide is optimized for Next.js 16 with React 19. Keep it updated as frameworks evolve.*
