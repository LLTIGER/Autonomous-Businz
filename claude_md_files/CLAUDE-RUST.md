...
All version numbers, tools and best‑practice links are current as of **Rust 1.93 (2026‑02‑20)**.
...
This file provides comprehensive guidance to **Claude Code** when working with Rust 1.93+ projects.
...
## 🚀 Rust 1.93 Key Features (February 2026)
...
5. **MUST** keep the workspace compiling on **stable** Rust 1.93.
